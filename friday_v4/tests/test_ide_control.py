...
class TestIdeParsing:
    def test_open_target(self):
        from friday_v4.nlu.intent import _ide_target
    ...
    def test_line_phrase_target(self):
        from friday_v4.nlu.intent import _ide_target, _ide_line
    ...
    def test_diagnostics_are_not_control(self):
        from friday_v4.nlu.intent import _ide_control_verb
...
def ide_env(tmp_path, monkeypatch):
    ...
    import friday_v4.desktop.ide.controller as ctl
    ...
    monkeypatch.setattr(
        "friday_v4.desktop.ide.detection.detect", lambda: _FakeIDE())
