"""Hermetic tests for the Wave 10 persona layer (friday_v4.persona).
...
- CLI: friday4 persona profile / remember
...
class TestPrompts:
    def test_context_empty_when_unknown(self, tmp_path):
        from friday_v4.persona import build_persona_context
...
class TestReasoningWiring:
    ...
    def test_classify_identity(self):
        from friday_v4.reasoning import classify, QuestionType
...
class TestNlRouterWiring:
    def test_no_persona_keyword_intent(self):
        ...
        from friday_v4.understanding import Intent, classify
...
class TestCliPersona:
    def _run(self, argv, tmp_path):
        from friday_v4.cli_persona import main
    ...
    def test_cmd_handlers_direct(self, tmp_path, capsys):
        ...
        from friday_v4.cli_persona import cmd_persona_profile, \
