...
import friday_v4.desktop.app_aliases as A
...
class TestClassifierRouting:
    def test_learning_phrases_classify_desktop(self):
        from friday_v4.nlu.intent import _fallback_classify
...
# ==========================================================================
# CLI — friday4 desktop aliases / teach / forget
# ==========================================================================


class TestDesktopCli:
    def test_teach_learns(self, store, capsys):
        from friday_v4.cli_desktop import cmd_desktop_teach
        import argparse
    ...
    def test_aliases_lists_and_forget_removes(self, store, capsys):
        from friday_v4.cli_desktop import (cmd_desktop_aliases,
                                           cmd_desktop_forget)
        import argparse
        A.learn_alias("todo app", "obsidian")
...
class TestCollabSync:
    ...
    def test_cli_sync_pushes_local_and_applies_remote(self, store, capsys,
                                                      monkeypatch):
        import argparse
        import friday_v4.collab as collab_mod
        from friday_v4.cli_desktop import cmd_desktop_aliases_sync
