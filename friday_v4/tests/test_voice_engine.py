...
class TestKokoroURLs:
    def test_model_url_points_to_v10_asset(self):
        ...
        from friday_v4.voice.tts import _KOKORO_MODEL_URL, _KOKORO_VOICES_URL
    ...
    def test_download_is_atomic_and_size_checked(self, tmp_path):
        ...
        to load forever."""
        from friday_v4.voice.tts import KokoroONNXProvider
...
class TestTTSSpeak:
    def test_speak_synthesizes_and_plays(self, tmp_path):
        ...
        with patch("friday_v4.voice.tts.play_wav_file") as mock_play:
    ...
    def test_multi_sentence_not_cached_partially(self, tmp_path):
        ...
        tts._current_provider = _FakeProvider()
        with patch("friday_v4.voice.tts.queue_wav") as mock_queue, \
             patch("friday_v4.voice.tts.flush_play_queue"), \
             patch("friday_v4.voice.tts.play_wav_file"):
...
class TestVoiceEngine:
    def _make_engine(self, config=None, **kwargs):
        from friday_v4.voice.core import VoiceEngine
