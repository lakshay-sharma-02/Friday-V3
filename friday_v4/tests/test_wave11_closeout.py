...
class TestReports:
    def test_daily_report_empty_db_is_honest(self, conn):
        from friday_v4.synthesis import build_daily_report
    ...
    def test_weekly_report_deterministic(self, conn):
        from friday_v4.synthesis import build_weekly_report
    ...
    def test_reports_never_raise_on_missing_conn(self, tmp_path):
        from friday_v4.synthesis import build_daily_report, build_weekly_report
    ...
    def test_report_cli_daily_flag_hermetic(self, capsys, tmp_path):
        ...
        from friday_v4.cli_research import cmd_report
        from friday_v4 import db
        dbp = tmp_path / "v4.db"
        conn = db.connect(dbp)
