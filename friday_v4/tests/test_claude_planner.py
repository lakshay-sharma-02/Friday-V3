...
- the NL router end-to-end: ``friday4 talk "ship the auth refactor"``
...
from friday_v4.missions import Planner
...
def _cp(tmp_path, conn=None, **kw):
    ...
    from friday_v4.missions import ClaudePlanner
...
class TestReplan:
    def test_make_planner_env_off_deterministic(self, tmp_path):
        ...
        from friday_v4.missions import make_planner
    ...
    def test_replan_request_detection(self):
        ...
        from friday_v4.nl_router import _is_replan_request
