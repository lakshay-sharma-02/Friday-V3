...
class TestEffectiveTone:
    def test_direction_wins_over_depth(self):
        from friday_v4.relationship.tones import (
            ToneDirection,
            effective_tone,
            effective_verbosity,
        )
    ...
    def test_no_direction_uses_depth(self):
        from friday_v4.relationship.tones import effective_tone
        assert effective_tone(0.9) == "close"
        assert effective_tone(0.1) == "neutral"

    def test_from_dict(self):
        from friday_v4.relationship.tones import ToneDirection
...
class TestToneCli:
    ...
    def test_set_tone(self, tmp_path, capsys):
        from friday_v4.cli_relationship import cmd_relationship_tone
