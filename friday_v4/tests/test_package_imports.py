...
class TestPackageImports:
    @pytest.mark.parametrize(
        ...
        [
            ...
            "friday_v4.network",
            "friday_v4.execution",
            "friday_v4.understanding",
            "friday_v4.missions",
            "friday_v4.reasoning",
            "friday_v4.memory",
            "friday_v4.persona",
            "friday_v4.relationship",
            "friday_v4.skills",
        ],
    )
    ...
    def test_mobile_available_after_wave15(self):
        ...
        module = importlib.import_module("friday_v4.mobile")
    ...
    def test_network_available_after_wave12(self):
        ...
        module = importlib.import_module("friday_v4.network")
        assert module.is_available() is True
    ...
    def test_collab_available_after_wave5(self):
        ...
        module = importlib.import_module("friday_v4.collab")
        assert module.is_available() is True
    ...
    def test_security_available_after_wave3(self):
        ...
        itself as available (stub-state marker flipped)."""
        module = importlib.import_module("friday_v4.security")
        assert module.is_available() is True
    ...
    def test_understanding_available_after_wave9(self):
        ...
        module = importlib.import_module("friday_v4.understanding")
        assert module.is_available() is True
    ...
    def test_nl_router_importable(self):
        ...
        from friday_v4.nl_router import TextCommandHandler, TalkResult, \
            voice_confirm
    ...
    def test_reasoning_available_after_wave9(self):
        ...
        reports itself as available."""
        module = importlib.import_module("friday_v4.reasoning")
        assert module.is_available() is True
        for name in ("answer", "parse", "validate", "Evidence"):
            assert getattr(module, name) is not None

    def test_cli_ask_importable(self):
        """`friday4 ask` (evidence-cited answers) imports cleanly."""
        from friday_v4.cli_ask import cmd_ask, build_ask_parser
        assert cmd_ask is not None
        assert build_ask_parser is not None

    def test_cli_memory_importable(self):
        """`friday4 memory` (Wave 10 facts CLI) imports cleanly."""
        from friday_v4.cli_memory import (cmd_memory_store,
                                          build_memory_parser)
        assert cmd_memory_store is not None
        assert build_memory_parser is not None

    def test_cli_nl_importable(self):
        """`friday4 talk` (natural language) imports cleanly."""
        from friday_v4.cli_nl import cmd_talk, build_talk_parser
    ...
    def test_execution_available_after_wave9(self):
        ...
        itself as available."""
        module = importlib.import_module("friday_v4.execution")
        assert module.is_available() is True
    ...
    def test_missions_available_after_wave9(self):
        ...
        itself as available."""
        module = importlib.import_module("friday_v4.missions")
        assert module.is_available() is True
    ...
    def test_memory_available_after_wave10(self):
        ...
        itself as available."""
        module = importlib.import_module("friday_v4.memory")
        assert module.is_available() is True
    ...
    def test_persona_available_after_wave10(self):
        ...
        module = importlib.import_module("friday_v4.persona")
        assert module.is_available() is True
    ...
    def test_cli_persona_importable(self):
        """`friday4 persona` (Wave 10 identity CLI) imports cleanly."""
        from friday_v4.cli_persona import (cmd_persona_remember,
    ...
    def test_relationship_available_after_wave10(self):
        ...
        reports itself as available."""
        module = importlib.import_module("friday_v4.relationship")
        assert module.is_available() is True
    ...
    def test_skills_available_after_wave10(self):
        ...
        itself as available."""
        module = importlib.import_module("friday_v4.skills")
        assert module.is_available() is True
    ...
    def test_cli_relationship_importable(self):
        """`friday4 relationship` (Wave 10 CLI) imports cleanly."""
        from friday_v4.cli_relationship import (cmd_relationship_status,
    ...
    def test_cli_skills_importable(self):
        """`friday4 skills` (Wave 10 CLI) imports cleanly."""
        from friday_v4.cli_skills import (cmd_skills_list,
                                          build_skills_parser)
    ...
    def test_cli_mobile_importable(self):
        """`friday4 mobile` (Wave 15 companion transport) imports cleanly."""
        from friday_v4.cli_mobile import (build_mobile_parser,
    ...
    def test_cli_missions_importable(self):
        """`friday4 mission` (Wave 9/18 CLI — Claude Code planner surface)
        imports cleanly."""
        from friday_v4.cli_missions import (build_mission_parser,
                                            cmd_mission_create,
                                            cmd_mission_replan)
