...
class TestSharedSession:
    def test_single_thread_across_surfaces(self, tmp_path):
        ...
        from friday_v4.persona.learn import record_statement
...
class TestClassification:
    def test_time_windowed_conversation_questions(self):
        from friday_v4.reasoning.question import QuestionType, classify
    ...
    def test_window_bounds(self):
        from friday_v4.reasoning.providers import _conversation_window
