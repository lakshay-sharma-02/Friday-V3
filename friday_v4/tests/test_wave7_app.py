...
Covers the companion PWA served by `friday4 mobile serve` — static app
...
from friday_v4.mobile.api import _APP_DIR, _APP_FILES
...
class TestPWAServing:
    def test_root_serves_the_app_shell(self, server):
        ...
        html = body.decode()
        assert "FRIDAY V4 — Companion" in html
    ...
    def test_asset_content_types(self, server):
        for path, frag, ctype in [
            ("/app.js", "FRIDAY V4 — Companion", "javascript"),
            ("/app.css", "--cyan", "css"),
