...
BUILTIN_WORKERS: List[Worker] = [
    ...
    _builtin_worker(
        "Synthesis", KIND_FUNCTION,
        "LLM-powered content synthesis for integration analysis, patterns documentation, and feasibility planning.",
        ["Synthesis", "Documentation", "Architecture", "Research",
         "Reasoning", "Static Analysis", "Code Review"],
        languages=["Markdown"],
        task_types=["analysis", "documentation", "implementation", "design",
                    "research"],
        plan_types=["integration", "feature", "research", "architecture",
                    "documentation"],
        limitations=["Requires network access to LLM", "No code execution"],
        speed="medium", cost="medium", context_window=0, parallelism=1,
        network=True, filesystem=True, git=False, python=False, shell=False,
        confidence="medium",
    ),
    # --- Pillar A: Desktop/Window/App control workers ---------------------
    _builtin_worker(
        "Hyprctl", KIND_CLI,
        "Hyprland window manager control: launch apps, switch workspaces, focus/move/resize/close windows, fullscreen, toggle floating.",
        ["Window Management", "Workspace Control", "Application Launcher"],
        languages=[],
        task_types=["infrastructure", "configuration", "cleanup"],
        plan_types=["infrastructure", "maintenance"],
        limitations=["Requires Hyprland running on this machine",
                     "No effect outside Hyprland session"],
        speed="fast", cost="low", context_window=0, parallelism=1,
        network=False, filesystem=False, git=False, python=False, shell=True,
        confidence="high",
    ),
    # --- Pillar A Layer 2: Browser automation ------------------------------
    _builtin_worker(
        "Browser", KIND_FUNCTION,
        "Browser automation via Chrome DevTools Protocol: navigate, click, type, read, wait, screenshot. Controls Brave/Chrome via CDP websocket.",
        ["Browser Automation", "Research"],
        languages=[],
        task_types=["analysis", "research", "verification"],
        plan_types=["infrastructure", "maintenance", "research"],
        limitations=["Requires Brave/Chrome with CDP port 9222",
                     "JavaScript-heavy SPAs may require wait actions"],
        speed="medium", cost="low", context_window=0, parallelism=1,
        network=True, filesystem=False, git=False, python=False, shell=False,
        confidence="medium",
    ),
]
