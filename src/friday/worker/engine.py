...
BUILTIN_WORKERS: List[Worker] = [
    ...
    _builtin_worker(
        ...
        ["Python", "Testing", "Static Analysis", "File Editing", "Benchmarking"],
        languages=["Python"],
    ...
    _builtin_worker(
        ...
        limitations=["Architecture reasoning", "Code comprehension"],
        speed="fast", cost="low", context_window=0, parallelism=1,
