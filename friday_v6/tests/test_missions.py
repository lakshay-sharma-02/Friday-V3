"""Hermetic tests for the Wave 9 missions layer (friday_v6.missions).
...
from friday_v6.missions import (
    MissionEngine,
    MissionStatus,
    Planner,
    Scheduler,
...
class TestModels:
    def test_step_payload_contract(self):
        from friday_v6.missions import make_step_payload
    ...
    def test_mission_progress(self):
        from friday_v6.missions import Mission, MissionStep
