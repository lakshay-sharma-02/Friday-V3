...
class TestSessionStore:
    def _make_store(self, tmp_path, monkeypatch):
        ...
        from friday_v6.proactive import session_memory as sm
...
class TestPatternLearner:
    def _make_learner(self, tmp_path, monkeypatch):
        ...
        from friday_v6.proactive import pattern_learner as pl
...
class TestAnticipationLastAction:
    def test_anticipation_passes_real_last_action(self, tmp_path, monkeypatch):
        ...
        from friday_v6.proactive.context_engine import WorkContext
...
class TestDesktopObserver:
    ...
    def test_get_active_repo_no_desktop(self):
        ...
        from friday_v6.proactive.context_engine import DeepContextEngine
...
class TestProactiveWatchSuggestion:
    """`friday6 proactive watch` must learn AND suggest standalone — the
    ...
    def test_cmd_watch_wires_suggestion_channel(self):
        ...
        from friday_v6.cli_proactive import cmd_proactive_watch
        ...
        with patch("friday_v6.proactive.AnticipationEngine",
                   return_value=engine) as mock_engine_cls, \
             patch("friday_v6.desktop.notifier.ProactiveSuggestionChannel",
                   return_value=channel) as mock_channel_cls, \
             patch("friday_v6.cli_proactive.time.sleep",
