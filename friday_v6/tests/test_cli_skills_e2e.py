"""End-to-end integration test: `friday6 skills` through the real CLI parser.
...
from friday_v6.cli_skills import main as skills_cli


def _record_demo_work(conn, repo: str = "friday_v6") -> None:
