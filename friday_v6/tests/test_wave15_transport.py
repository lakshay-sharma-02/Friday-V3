...
from friday_v6.ambient.channels import desktop_channel, speak_channel
...
class TestPushService:
    def test_delivers_new_events_and_advances_cursor(self, tmp_path):
        from friday_v6.mobile import PushNotificationService
    ...
    def test_file_transporter_writes_jsonl_outbox(self, tmp_path):
        from friday_v6.mobile import PushNotificationService, file_transporter
...
class TestWebConversation:
    def test_conversation_state_reads_shared_thread(self, tmp_path):
        ...
        try:
            ...
            # dashboard resolves `db` via `from friday_v6 import db` at
...
class TestDaemonWiring:
    def test_wire_channels_subscribes_surfaces(self, tmp_path):
        from friday_v6.daemon import AmbientWorker
...
class TestMobilePushWorker:
    ...
    phone on a schedule (no manual `friday6 mobile push`)."""
    ...
    def test_daemon_builds_mobile_worker_when_enabled(self, tmp_path,
        ...
        import friday_v6.mobile.push as push_mod
