"""Hermetic tests for the Wave 10 relationship layer (friday_v6.relationship).
...
from friday_v6.relationship import (
    RelationshipEngine,
    ToneSelector,
    briefing_length,
    compute_depth,
...
class TestPersonaWiring:
    def test_identity_profile_tone_from_relationship(self, tmp_path):
        from friday_v6.persona import IdentityEngine
        conn = _conn(tmp_path)
        try:
