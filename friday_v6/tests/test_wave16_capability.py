...
from friday_v6.capability import Capability, CapabilityRegistry
...
class TestCapabilityCli:
    ...
    def test_list(self, tmp_path, capsys):
        from friday_v6.cli_capability import cmd_capability_list
    ...
    def test_describe(self, tmp_path, capsys):
        from friday_v6.cli_capability import cmd_capability_describe
    ...
    def test_count(self, tmp_path, capsys):
        from friday_v6.cli_capability import cmd_capability_count
...
class TestWave16Exports:
    def test_capability_layer_exports(self):
        from friday_v6.capability import (
            Capability,
            CapabilityRegistry,
            is_available,
        )
