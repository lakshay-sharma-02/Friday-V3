"""Hermetic tests for the Wave 9 execution layer (friday_v6.execution).
...
from friday_v6.execution import (
    AuditLogger,
    PermissionGate,
    PermissionLevel,
    Sandbox,
...
class TestClaudeWorkspace:
    ...
    def test_clone_workspace_is_projects_parent(self, tmp_path, monkeypatch):
        from friday_v6.execution.executors import _claude_workspace
    ...
    def test_clone_destination_derives_repo_name(self, tmp_path):
        from friday_v6.execution.executors import _clone_destination
