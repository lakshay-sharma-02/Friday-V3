...
from friday_v6.research import analyze, correlate, CodeSearch, impact
from friday_v6.research.architecture import _CACHE, RepoProfile
...
def test_readme_purpose(repo_a: Path):
    from friday_v6.research import readme_purpose
