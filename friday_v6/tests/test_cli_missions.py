"""Hermetic tests for `friday6 mission` — the missions-layer CLI (Wave 9 + 18).

The Wiring Law surface: every layer gets its ``friday6 <layer> …``
...
from friday_v6 import cli_missions as cli
