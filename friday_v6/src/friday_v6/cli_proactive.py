"""CLI commands for `friday6 proactive` — proactive intelligence & context awareness.

Usage:
    friday6 proactive status        # Show what FRIDAY knows about your context
    friday6 proactive suggest       # Get proactive suggestions now
    friday6 proactive learn         # Show learning stats and patterns
    friday6 proactive brief         # Get a morning/evening briefing
    friday6 proactive observe       # Manually trigger an observation
    friday6 proactive watch         # Learn patterns + notify suggestions (standalone)
"""
...
logger = logging.getLogger("friday_v6.cli_proactive")
...
def build_proactive_parser(subparsers) -> None:
    """Build subparser for `friday6 proactive`."""
...
def main(argv: list[str] | None = None) -> int:
    """Standalone entry point for `friday6 proactive`."""
    logging.basicConfig(level=logging.WARNING)

    parser = argparse.ArgumentParser(prog="friday6 proactive")
