...
``friday_v6.db`` typed helpers; V3 data is optional and additive.
"""
...
logger = logging.getLogger("friday_v6.reasoning.providers")
...
def llm_provider(question: Question, conn=None, best: Optional[Answer] = None,
    ...
    ("and the tests?") — ``friday6 ask`` is conversation-capable. An
