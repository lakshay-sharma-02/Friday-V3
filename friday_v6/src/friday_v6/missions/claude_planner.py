...
deterministic :class:`~friday_v6.missions.planner.Planner` is always
...
logger = logging.getLogger("friday_v6.missions.claude_planner")
...
class ClaudePlanner:
    """An :data:`~friday_v6.missions.planner.Enhancer` backed by Claude Code.
