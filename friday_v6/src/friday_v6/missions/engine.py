...
layer* (``friday_v6.execution.execute`` — gate → sandbox → audit), and
...
logger = logging.getLogger("friday_v6.missions.engine")
...
class MissionEngine:
    ...
    def advance(self, mission_id: str, *,
        ...
        - Executable steps → ``friday_v6.execution.execute``.
