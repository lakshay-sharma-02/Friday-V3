...
Usage:
    from friday_v6.skills import ReplayExecutor, ShadowExecutor
...
try:
    ...
    _MARKDOWN_SKILLS_AVAILABLE = True
    ...
    DEFAULT_USER_SKILLS_DIR = None  # type: ignore
    MarkdownSkill = None  # type: ignore
    MarkdownSkillLibrary = None  # type: ignore
    _SKILLS_AVAILABLE = False
    _MARKDOWN_SKILLS_AVAILABLE = False
