...
The agenda lives at `~/.friday/v6_vault/wiki/schedule.md` (create it on first use).
...
- **Read first.** If `schedule.md` exists, read it before editing so you append, not overwrite.
...
- `~/.friday/v6_vault/wiki/me.md` — operator preferences
- `~/.friday/v6_vault/raw/` — turn log (do not edit)
