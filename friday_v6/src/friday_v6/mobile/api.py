...
logger = logging.getLogger("friday_v6.mobile.api")
...
class MobileAPI:
    ...
    def talk(self, text: str) -> dict:
        ...
        The phone speaks to the same Friday as ``friday6 talk``, voice,
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    llm = None
                # Same desktop handler as friday6 talk / the web chat —
