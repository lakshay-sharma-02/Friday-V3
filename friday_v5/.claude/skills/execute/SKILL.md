...
- If the work produces a useful artifact (a report, a diff summary, test output), save it to `vault/outputs/` with a dated filename and link it with `[[outputs/name]]`.
- Log the outcome in your reply; heavy logs stay in `vault/raw/`.

## Related

- `vault/outputs/` — artifacts directory
- `vault/wiki/me.md` — operator's preferred tooling
