...
- `vault/wiki/me.md` — about the operator: preferences, habits, constraints, identity.
- `vault/wiki/people.md` — people: roles, relationships, key facts (one `## Name` section each).
- `vault/wiki/projects.md` — projects: purpose, stack, links to notes.
...
- `vault/raw/` — the verbatim turn log (do not edit)
